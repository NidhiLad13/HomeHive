...
export default function CreateListing() {
    ...
    const { type, name, bedrooms,bathrooms, parking, furnished, address, description, offers, regularPrice, discountedPrice } = formData;
  return (
    <main className='max-w-md px-2 mx-auto'>
        ...
        <form>
            ...
            <button type='submit' className='mb-6 w-full px-7 py-3 bg-blue-700 text-white font-sm uppercase rounded shadow-md hover:bg-blue-900 hover:shadow-lg focus:bg-blue-80 focus:shadow-lg active:bg-blue-900 active:shadow-lg transition duration-150 ease-in-out'>Create Listing</button>
        </form>
    </main>
  );
}
